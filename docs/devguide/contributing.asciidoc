...
https://github.com/k0ffee/beats/blob/main/CHANGELOG.next.asciidoc[CHANGELOG.next.asciidoc].
...
https://github.com/k0ffee/beats/blob/main/CHANGELOG-developer.next.asciidoc[here].
