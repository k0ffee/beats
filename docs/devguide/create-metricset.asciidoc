...
https://github.com/k0ffee/beats/blob/main/metricbeat/scripts/module/metricset/metricset.go.tmpl
...
https://godoc.org/github.com/k0ffee/beats/libbeat/common#MapStr[MapStr API docs].
...
https://godoc.org/github.com/k0ffee/beats/libbeat/common/schema[schema] package
...
----
import (
	s "github.com/k0ffee/beats/libbeat/common/schema"
	c "github.com/k0ffee/beats/libbeat/common/schema/mapstrstr"
)
