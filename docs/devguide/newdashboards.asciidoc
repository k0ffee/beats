...
https://github.com/k0ffee/beats/tree/master/testing/environments[beats/testing/environments] to import, create, and
...
https://github.com/k0ffee/beats/tree/master/dev-tools/cmd/dashboards[dev-tools].  
See the dev-tools https://github.com/k0ffee/beats/tree/master/dev-tools/README.md[readme] for more info.
