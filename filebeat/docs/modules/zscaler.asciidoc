...
:edit_url: https://github.com/k0ffee/beats/edit/main/x-pack/filebeat/module/zscaler/_meta/docs.asciidoc
...
The port to listen for syslog traffic. Defaults to `9521`
