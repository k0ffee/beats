...
import (
	...
	cfg "github.com/k0ffee/beats/v7/filebeat/config"
	"github.com/k0ffee/beats/v7/filebeat/fileset"
	_ "github.com/k0ffee/beats/v7/filebeat/include"
	"github.com/k0ffee/beats/v7/filebeat/input"
	v2 "github.com/k0ffee/beats/v7/filebeat/input/v2"
	"github.com/k0ffee/beats/v7/filebeat/input/v2/compat"
	"github.com/k0ffee/beats/v7/filebeat/registrar"
	...
	"github.com/k0ffee/beats/v7/libbeat/publisher/pipetool"
	...
	_ "github.com/k0ffee/beats/v7/filebeat/processor/add_kubernetes_metadata"
	_ "github.com/k0ffee/beats/v7/libbeat/processors/decode_csv_fields"

	// include all filebeat specific autodiscover features
	_ "github.com/k0ffee/beats/v7/filebeat/autodiscover"
)
