...
import (
	...
	"github.com/k0ffee/beats/v7/x-pack/dockerlogbeat/pipelinemock"
...
func TestDefaultHarvesterGroup(t *testing.T) {
	t.Skip("flaky test: https://github.com/k0ffee/beats/issues/26727")
	...
	t.Run("assert a harvester can be stopped and removed from bookkeeper", func(t *testing.T) {
		t.Skip("flaky test: https://github.com/k0ffee/beats/issues/25805")
