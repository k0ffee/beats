...
Vagrant.configure("2") do |config|
  ...
  #  docker run -v $(pwd):"/root/go/src/github.com/elastic/beats" -w /root/go/src/github.com/k0ffee/beats/metricbeat/module/system/process --entrypoint="/usr/local/go/bin/go" -it docker.elastic.co/beats-dev/golang-crossbuild:1.16.6-darwin-debian10 test -v -tags=integrations -run TestFetch
