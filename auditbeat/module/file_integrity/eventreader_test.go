...
func TestEventReader(t *testing.T) {
	t.Skip("Flaky test: about 1/10 of builds fails https://github.com/k0ffee/beats/issues/21302")
	// Make dir to monitor.
...
func TestRaces(t *testing.T) {
	t.Skip("Flaky test: about 1/20 of builds fails https://github.com/k0ffee/beats/issues/21303")
	const (
