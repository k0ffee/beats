...
import (
	fbcmd "github.com/k0ffee/beats/v7/filebeat/cmd"
	cmd "github.com/k0ffee/beats/v7/libbeat/cmd"

	// Register the includes.
	_ "github.com/k0ffee/beats/v7/x-pack/filebeat/include"
	inputs "github.com/k0ffee/beats/v7/x-pack/filebeat/input/default-inputs"
