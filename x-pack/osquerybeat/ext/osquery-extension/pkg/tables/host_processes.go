...
import (
	...
	"github.com/k0ffee/beats/v7/x-pack/osquerybeat/ext/osquery-extension/pkg/hostfs"
	"github.com/k0ffee/beats/v7/x-pack/osquerybeat/ext/osquery-extension/pkg/proc"
)
