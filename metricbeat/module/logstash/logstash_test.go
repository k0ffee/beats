...
import (
	...
	"github.com/k0ffee/beats/v7/metricbeat/module/logstash"

	// Make sure metricsets are registered in mb.Registry
	_ "github.com/k0ffee/beats/v7/metricbeat/module/logstash/node"
	_ "github.com/k0ffee/beats/v7/metricbeat/module/logstash/node_stats"
)
