...
import (
	...
	"github.com/k0ffee/beats/v7/metricbeat/mb/module"
	conf "github.com/elastic/elastic-agent-libs/config"

	// include all metricbeat specific builders
	_ "github.com/k0ffee/beats/v7/metricbeat/autodiscover/builder/hints"

	// include all metricbeat specific appenders
	_ "github.com/k0ffee/beats/v7/metricbeat/autodiscover/appender/kubernetes/token"

	// Add metricbeat default processors
	_ "github.com/k0ffee/beats/v7/metricbeat/processor/add_kubernetes_metadata"
)
