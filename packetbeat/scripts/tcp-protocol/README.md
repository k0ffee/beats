...
```
python ${GOPATH}/src/github.com/k0ffee/beats/packetbeat/scripts/create_tcp_protocol.py
```
...
```
  $ cd ${GOPATH}/src/github.com/k0ffee/beats/packetbeat
  $ python ${GOPATH}/src/github.com/k0ffee/beats/packetbeat/scripts/create_tcp_protocol.py
```

Load plugin into packetbeat by running `make update`. Or add `_
"github.com/k0ffee/beats/v7/packetbeat/protos/echo"` to the import list in
`$GOPATH/src/github.com/k0ffee/beats/packetbeat/include/list.go`.
...
`$GOPATH/src/github.com/k0ffee/beats/packetbeat/protos` and importing module in
`$GOPATH/src/github.com/k0ffee/beats/packetbeat/include/list.go`.
...
import (
	...
	"github.com/k0ffee/beats/v7/packetbeat/beater"
