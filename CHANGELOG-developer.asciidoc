...
=== Beats version 8.0.0
https://github.com/k0ffee/beats/compare/7.x..main[Check the HEAD diff]
...
=== Beats version 7.5.1
https://github.com/k0ffee/beats/compare/v7.5.0..v7.5.1[Check the HEAD diff]

=== Beats version 7.5.0
https://github.com/k0ffee/beats/compare/v7.4.1..v7.5.0[Check the HEAD diff]
...
=== Beats version 7.4.1
https://github.com/k0ffee/beats/compare/v7.4.0..v7.4.1[Check the HEAD diff]

=== Beats version 7.4.0
https://github.com/k0ffee/beats/compare/v7.3.1..v7.4.0[Check the HEAD diff]
...
=== Beats version 7.3.2
https://github.com/k0ffee/beats/compare/v7.3.1..v7.3.2[Check the HEAD diff]

=== Beats version 7.3.1
https://github.com/k0ffee/beats/compare/v7.3.0..v7.3.1[Check the HEAD diff]

=== Beats version 7.3.0
https://github.com/k0ffee/beats/compare/v7.2.1..v7.3.0[Check the HEAD diff]
...
=== Beats version 7.2.1
https://github.com/k0ffee/beats/compare/v7.2.0..v7.2.1[Check the HEAD diff]

=== Beats version 7.2.0
https://github.com/k0ffee/beats/compare/v7.1.1..v7.2.0[Check the HEAD diff]
...
=== Beats version 7.1.1
https://github.com/k0ffee/beats/compare/v7.1.0..v7.1.1[Check the HEAD diff]

=== Beats version 7.1.0
https://github.com/k0ffee/beats/compare/v7.0.0..v7.1.0[Check the HEAD diff]

=== Beats version 7.0.1
https://github.com/k0ffee/beats/compare/v7.0.0..v7.0.1[Check the HEAD diff]

=== Beats version 7.0.0-GA
https://github.com/k0ffee/beats/compare/v7.0.0-rc2..v7.0.0[Check the HEAD diff]
...
https://github.com/k0ffee/beats/compare/v6.3.0..v7.0.0-alpha2[Check the HEAD diff]
...
- Dashboards under _meta/kibana are expected to be decoded. See https://github.com/k0ffee/beats/pull/7224 for a conversion script. {pull}7265[7265]
- Constructor `(github.com/k0ffee/beats/libbeat/output/codec/json).New` expects a new `escapeHTML` parameter. {pull}7445[7445]
