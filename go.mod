module github.com/k0ffee/beats/v7
...
replace (
	...
	github.com/apoydence/eachers => github.com/poy/eachers v0.0.0-20181020210610-23942921fe77 //indirect, see https://github.com/k0ffee/beats/pull/29780 for details.
